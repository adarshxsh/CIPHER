...
- [ ] Milestone 4: NAT Traversal (Hole punching with AutoNAT & Relay)
- [ ] Milestone 5: Discovery (mDNS & DHT routing)

## Phase 3: Protocol Refinement
- [ ] Milestone 6: Chunking & Merkle Verification
- [ ] Milestone 7: Encryption & Authentication

## Phase 4: Release
- [ ] Milestone 8: End-to-End Testing & Polish
