...
./bin/publisher -p 45001 -ws-port 45002 -identity ./store_publisher/identity.key -store ./store_publisher -file test_input.dat -export-key-file ./publisher.key > publisher.log 2>&1 &
PUB_PID=$!
