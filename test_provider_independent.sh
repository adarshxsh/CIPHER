...
rm -f test_orig.dat test_recov1.dat test_recov2.dat pub.key
...
./bin/publisher -seed=false -identity ./store_provider/pub.key -store ./store_provider -file test_orig.dat -key-out pub.key > publisher.log 2>&1
