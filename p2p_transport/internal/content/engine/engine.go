...
// Reassemble reads the manifest, fetches chunks sequentially, decrypts them, verifies integrity, and writes directly to w.
func (e *ContentEngine) Reassemble(ctx context.Context, m *manifest.Manifest, w io.Writer) error {
	...
	// Fetch each chunk sequentially, verify, decrypt, and stream directly to w.
