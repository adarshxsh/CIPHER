...
// CanonicalBytes returns the JSON serialization of the manifest with Descriptor.ID zeroed.
...
// ComputeDigest computes the SHA-256 digest over the canonical manifest payload.
