...
func Send(s network.Stream, filePath string) error {
	...
	// 1. Construct and Write Header (Checksum initialized to zero; calculated inline)
	header := &Header{
	...
	// 2. Send Data with Progress Tracking and Inline SHA-256 Hashing
	...
	// 3. Write Trailing SHA-256 Checksum
