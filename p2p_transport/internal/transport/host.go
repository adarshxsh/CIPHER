...
func NewNode(ctx context.Context, listenPort int, wsPort int, priv crypto.PrivKey, relayAddr string, forceRelay bool, nodeOpts ...NodeOption) (host.Host, *dht.IpfsDHT, error) {
	...
	if cfg.rcmgr == nil {
		if cfg.limiter == nil {
			...
			scaledCfg.AddProtocolLimit(protocol.ChunkTransportProtocolID, rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 64 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})
			scaledCfg.AddProtocolPeerLimit(protocol.ChunkTransportProtocolID, rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 64 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})

			scaledCfg.AddProtocolLimit(protocol.FileTransferProtocolID, rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 64 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})
			scaledCfg.AddProtocolPeerLimit(protocol.FileTransferProtocolID, rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 64 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})

			scaledCfg.AddProtocolLimit("/ipfs/id/1.0.0", rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 32 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})
			scaledCfg.AddProtocolPeerLimit("/ipfs/id/1.0.0", rcmgr.BaseLimit{Streams: 32, StreamsInbound: 32, StreamsOutbound: 32, Memory: 32 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})

			scaledCfg.AddProtocolLimit("/ipfs/kad/1.0.0", rcmgr.BaseLimit{Streams: 100, StreamsInbound: 100, StreamsOutbound: 100, Memory: 32 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})
			scaledCfg.AddProtocolPeerLimit("/ipfs/kad/1.0.0", rcmgr.BaseLimit{Streams: 32, StreamsInbound: 32, StreamsOutbound: 32, Memory: 32 * 1024 * 1024}, rcmgr.BaseLimitIncrease{})
