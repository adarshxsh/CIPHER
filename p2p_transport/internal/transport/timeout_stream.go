...
// Read refreshes the read deadline and executes Read on the underlying stream.
...
// Write refreshes the write deadline and executes Write on the underlying stream.
