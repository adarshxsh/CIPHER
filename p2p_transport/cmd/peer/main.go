...
func main() {
	...
	// Apply testing flags
	var chunkOpts []chunk.StreamHandlerOption
	if *corruptProb > 0 {
		chunkOpts = append(chunkOpts, chunk.WithCorruptProbability(*corruptProb))
	...
	chunk.NewStreamHandler(h, eng, chunkOpts...) // mp duplicate, have called it again later
	...
	chunk.NewStreamHandler(h, eng, chunkOpts...)
